                                                ...
                                                <td className="px-3 py-2.5 text-center">
                                                    <div className="flex items-center gap-1.5 justify-center">
                                                        <div className="w-10 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                                            <div
                                                                className={`h-full transition-all ${cx > 10 ? 'bg-red-500' :
                                                                        cx > 4 ? 'bg-orange-400' :
                                                                            'bg-green-500'
                                                                    }`}
                                                        ...
                                                        <div className="flex -space-x-1.5 items-center">
                                                            {deps.slice(0, 4).map((d, idx) => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={d.id || idx}
                                                                        className={`w-6 h-6 rounded-full border-2 border-white flex items-center justify-center text-[9px] font-semibold shadow-sm ${isMeasure
