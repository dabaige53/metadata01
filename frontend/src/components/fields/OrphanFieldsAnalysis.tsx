        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm border-l-4 border-l-red-500">
                    ...
                    <div className="text-2xl font-bold text-red-600">{allData.length.toLocaleString()}</div>
                    <div className="text-xs text-gray-400 mt-1">公式/名称聚合后，未被视图使用</div>
                </div>
