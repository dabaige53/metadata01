...
export default function DuplicateMetricsAnalysis() {
    ...
    const multiWorkbookCount = items.filter(m => m.workbook_count > 1).length;
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm border-l-4 border-l-red-500">
                    <div className="text-xs text-gray-500 uppercase mb-1">重复指标数</div>
                    <div className="text-2xl font-bold text-red-600">{totalCount}</div>
                    <div className="text-xs text-gray-400 mt-1">同一公式在多处使用</div>
                </div>
